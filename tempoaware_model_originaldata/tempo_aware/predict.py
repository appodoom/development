...
WEIGHTS_PATH = "./music_sheet_transformer_weights_20_epoch_originaldata.pth"
vocab_path = "./vocab_music_sheet_250.txt"
input_json_file = "./tokens_originaldata/tokens_corpus1.json"
...
model = MusicTransformer(vocab_size=250)
